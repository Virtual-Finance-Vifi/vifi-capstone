...
7. **Discussion: Key Observations and Risks**  
   7.1. Over-Collateralization and \(\omega\ge1\)  
...
| $U_{ns,n}$                | Staked USDV in the Treasury (Farm deposits)                                             | Treasury                        |
...
Hence, a user exchanging 1 USDV gets \(O_R\) units of TTD in principle, adjusted by the AMM’s internal state. The system carefully updates \(\omega\) to ensure \(\omega\ge1\).
...
- \(\displaystyle F_{e,n}\): The total TTDV to be “exited.”  
- \(\displaystyle F_{s,n}\): The portion used in the AMM to obtain \(R_{s,n}\).  
- \(\displaystyle F_{r,n} = R_{s,n}\times P_{R,n}\): The fraction used for direct redemption.
